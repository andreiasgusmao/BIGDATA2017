{-|
Description : Exercício 1 - Lista de Exercícios sobre ADT
Copyright   : (c) Andreia Gusmão, 2017
License     : GPL-3
Maintainer  : andreia.gusmao@ufabc.edu.br
Exercício 01: Resolva o problema da Zebra utilizando ADTs para representar as soluções. Para encontrar a resposta você deve enumerar todas as combinações até que encontre uma que atenda todas as restrições. Link: (https://en.wikipedia.org/wiki/Zebra_Puzzle) 
-}
